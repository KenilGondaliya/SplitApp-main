...
export default function ViewGroup() {
  ...
  const findUserSplit = (split) => {
    if (split && Array.isArray(split) && split.length > 0 && split[0] && typeof split[0] === 'object') {
      console.log('ViewGroup - findUserSplit split[0]:', split[0]);
      return split[0][emailId] || 0; // Safely access emailId, default to 0 if key missing
    }
    console.warn('ViewGroup - findUserSplit: Invalid split data', split);
    return 0;
  };
                  ...
                  {alertExpense ? (
                    ...
                    >
                      <Typography
                        ...
                        textAlign={"center"}
                      >
                        No expense present for this group! Record your first
                        group expense now <br />
                        <Link
                          component={RouterLink}
                          to={dataConfig.ADD_EXPENSE_URL + group?._id}
                        >
